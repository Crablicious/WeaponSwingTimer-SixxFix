...
local L = addon_data.localization_table
    ...
    L["Enables the player's off-hand on the main swing bar."]="Enables the player's off-hand on the main swing bar."
    ...
    L["Show Off-Hand on Main"]=" Show Off-Hand on Main"
...
if GetLocale() == "zhCN" then
    ...
    L["Enables the player's off-hand on the main swing bar."]="在主进度条上显示玩家副手。"
    ...
    L["Enable"]=" 启用"
    L["Show Off-Hand"]=" 副手"
    L["Show Off-Hand on Main"]=" 副手在主手上"
    L["Show border"]=" 边框"
    L["Classic bars"]=" 职业纹理"
    L["Fill / Empty"]=" 填充/空白"
...
if GetLocale() == "zhTW" then -- 供中国香港、中国澳门和中国台湾省同胞使用
	...
	L["Enables the player's off-hand on the main swing bar."]="在主進度條上显示玩家副手。"
